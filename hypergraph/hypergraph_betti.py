...
# Define the hypergraph as a list of hyperedges (each hyperedge is a list of vertices)
#hypergraph =[[5], [1,2], [0, 1, 2], [0, 1, 3], [0, 2, 3], [1, 2, 3]]
#hypergraph = [[1],[3]]
#hypergraph =[[1, 3], [0, 1, 2], [0, 1, 3], [2, 3, 4]]
hypergraph = [[0],[1],[2],[3],[4],[5],
              [0, 1], [1, 2], [2, 3], [3, 4], [4, 5], [0, 5]]
# Calculate Betti numbers using the function
betti_numbers = compute_betti_hypergraph(hypergraph)

# Print the Betti numbers
print("The Betti numbers of the hypergraph:")
print(betti_numbers)
